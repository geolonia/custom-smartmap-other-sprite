# Geolonia smartmap向けアイコンセット（カスタムタイル用）

地図用のSVGアイコンセットです。スマートマップのカスタムタイルで使用するアイコン（法定外など）をホストしています。

標準タイルで使用するアイコンは [geolonia/custom-smartmap-sprite](https://github.com/geolonia/custom-smartmap-sprite) でホストしています。
